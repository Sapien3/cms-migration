...
const EditViewDataManagerProvider = ({
  ...
  useInterval(function () {
    // console.debug('autosave', allLayoutData);
    const { draftAndPublish } = allLayoutData.contentType.options;
    // const modifiedData = state.modifiedData;
    const data = modifiedData;
    let published =
      data.published_at !== undefined && data.published_at !== null;
    if ("published_at" in modifiedData) {
      published =
        modifiedData.published_at !== undefined &&
        modifiedData.published_at !== null;
    }
    const modified = !isEqual(initialData, modifiedData);
    // console.debug("data", data, 'isCreatingEntry', isCreatingEntry, 'modified',modified, 'published', published, 'draftAndPublish', draftAndPublish);
